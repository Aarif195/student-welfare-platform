...
const resendOTPController = async (req, res) => {
    ...
    try {
        ...
        const student = await db_1.pool.query("SELECT email FROM students WHERE email = $1", [email]);
        const owner = await db_1.pool.query("SELECT email FROM HostelOwners WHERE email = $1", [email]);
        ...
        // 4. Send Email
        await (0, mailer_1.sendBookingEmail)(email, "New Verification Code Request", `
